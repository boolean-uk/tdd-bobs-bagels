...
describe ("Bobs's bagels:", () => {
    ...
    beforeEach(()=>{
        ...
        it('add valid item to default basket', () => {
            ...
            const result = store.basket.defaultBasket.items
        ...
        it('add invalid item to default basket', () => {
            ...
            expect(result).toEqual ('Invalid SKU! Please try again with a real product.')
        })

        it('remove valid item from default basket', () => {
            store.addItemToBasket('bGlo')
            store.removeItemFromBasket('bgls')
