...
const { addItem, removeItem, isFull, containsItem, setCapacity, getItemPrice, totalPrice } = require("../src/basket_ex1")
...
describe('Calculating discounts for bagels', () => {
    let basket
    let inventory
    ...
    it('should return total cost for bagel promos for 6, 12 and 2', () => {
        addItem(basket, inventory[0],20)
        expect(totalPrice(basket).toFixed(2)).toEqual('7.46')
    })

    it('should return total cost for bagel promos for 6 and 4', () => {
        addItem(basket, inventory[0],10)
        expect(totalPrice(basket)).toEqual(4.45)
    })

    it('should return total cost for bagel and coffee set', () => {
        addItem(basket, inventory[7])
        expect(totalPrice(basket)).toEqual(1.25)
    })
})